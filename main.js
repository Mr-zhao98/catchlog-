...
ui.layout(
    <viewpager id="viewpager">
        <frame bg={color}>
        <img src={"https://api.dujin.org/bing/m.php"} scaleType="centerCrop" alpha="0.4" />
            <vertical padding="16">
                <text textSize="16sp" textColor="#FFFFFF" text="请输入卡密"/>
                <input id="card" text=""/>
...
var store  = storages.create("1761630");
var cardmi = store.get("kami")
if(cardmi){
    ui.card.setText(cardmi)
}
...
const PJYSDK = (function(){
    function PJYSDK(app_key, app_secret){
        ...
        this.debug = true;
        this._lib_version = "v1.12";
        this._protocol = "http";
        this._hosts = ["api.paojiaoyun.com", "api2.paojiaoyun.com"];
...
let app_key = "c7ci7dbdqusv52enkp6g";  // 填软件AppKey，开发者后台获取
let app_secret = "7yvHt56NDOkE5lSPOA0YOTriIZduMtyP";  // 填软件AppSecret，开发者后台获取
let pjysdk = new PJYSDK(app_key, app_secret);

pjysdk.debug = true;  // 开启debug模式，会有详细的请求日志d
